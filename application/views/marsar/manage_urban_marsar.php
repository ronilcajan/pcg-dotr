<div class="container-fluid">
    <div class="white-box">
        <h3 class="box-title">URBAN MARITIME SEARCH AND RESCUE REPORT LISTS</h3>
    </div>
    <div class="white-box">
        <div class="row">
            <div class="col-md-12">
                <form id="urban_marsar-filter-form">
    ...
    <div class="white-box">
        ...
        <table class="table  table-responsive table-bordered" id="urban-marsar-table">
                ...
                <tr>
                    ...
                    <td> <a title="View" class="text-info"
                        ...
                        <a title="Delete" class="text-danger"
                            ...
                            href="<?= site_url('urban_marsar/delete/').$row->id ?>"><i class="fa fa-trash"></i></a>
