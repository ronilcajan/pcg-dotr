        ...
        <div class="col-md-12">
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="sub-station-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img class="img-fluid m-r-10"
                                        src="<?= site_url('assets/uploads/substation/').$row->substation_logo ?>"
                                        width="30" alt=""> <?= $row->sub_station ?></td>
                                <td><img class="img-fluid m-r-10"
                                        src="<?= site_url('assets/uploads/station/').$row->station_logo ?>" width="30"
                                        alt=""><?= $row->station ?></td>
