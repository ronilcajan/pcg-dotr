                ...
                <form method="POST" action="<?= site_url() ?>insert_marslec" role="form" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-primary setup-content" id="step-2">
                        ...
                        <div class="panel-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="ra_10654[]"
                                                id="ra_10654_<?php echo $row->id  ?>" value="<?php echo $row->id  ?>">
                                            <label
                                                for="ra_10654_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-12">RA 9165 (COMPREHENSIVE DANGEROUS DRUGS ACT OF 2022)
                                    </label>
                                    <div class="col-sm-12">
                                        <?php 
													...
													?>
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="ra_9165[]" id="ra_9165_<?php echo $row->id  ?>"
                                                value="<?php echo $row->id  ?>">
                                            <label
                                                for="ra_9165_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-12">RA 10591 (COMPREHENSIVE LAW ON FIREARMS AND AMMUNITION
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="ra_10591[]"
                                                id="ra_10591_<?php echo $row->id  ?>" value="<?php echo $row->id  ?>">
                                            <label
                                                for="ra_10591_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <?php 
													...
													?>
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="ra_9208[]" id="ra_9208_<?php echo $row->id  ?>"
                                                value="<?php echo $row->id  ?>">
                                            <label
                                                for="ra_9208_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-12">RA 9147 (WILDLIFE RESOURCES CONSERVATION AND PROTECTION
                                        ACT)</label>
                                    <div class="col-sm-12">
                                        <?php 
													...
													?>
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="ra_9147[]" id="ra_9147_<?php echo $row->id  ?>"
                                                value="<?php echo $row->id  ?>">
                                            <label
                                                for="ra_9147_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-12">PD NO. 705 (REVISED FORESTRY CODE OF THE
                                        PHILIPPINES)</label>
                                    <div class="col-sm-12">
                                        <?php 
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="pd_no_705[]"
                                                id="pd_no_705_<?php echo $row->id  ?>" value="<?php echo $row->id  ?>">
                                            <label
                                                for="pd_no_705_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <?php 
													...
													?>
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="ra_1937[]" id="ra_1937_<?php echo $row->id  ?>"
                                                value="<?php echo $row->id  ?>">
                                            <label
                                                for="ra_1937_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-12">PD No. 532 (ANTI-PIRACY AND ANTI-HIGHWAY ROBBERY LAW OF
                                        1974)</label>
                                    <div class="col-sm-12">
                                        <?php 
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="pd_no_532[]"
                                                id="pd_no_532_<?php echo $row->id  ?>" value="<?php echo $row->id  ?>">
                                            <label
                                                for="pd_no_532_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="ra_10066[]"
                                                id="ra_10066_<?php echo $row->id  ?>" value="<?php echo $row->id  ?>">
                                            <label
                                                for="ra_10066_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <?php 
													...
													?>
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="ra_6539[]" id="ra_6539_<?php echo $row->id  ?>"
                                                value="<?php echo $row->id  ?>">
                                            <label
                                                for="ra_6539_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="ra_10845[]"
                                                id="ra_10845_<?php echo $row->id  ?>" value="<?php echo $row->id  ?>">
                                            <label
                                                for="ra_10845_<?php echo $row->id  ?>"><?php echo $row->section ?></label>
                                        </div>
                                        <?php
														}
													?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="marpol_violation[]"
                                                id="marpol_violation_<?php echo $row->id  ?>"
                                                value="<?php echo $row->id  ?>">
                                            <label
                                                for="marpol_violation_<?php echo $row->id  ?>"><?php echo $row->marpol_violation ?></label>
                                        </div>
                                        <?php
														}
													?>
                        ...
                        <div class="panel-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="seaborne_patrol_activity_conduct[]"
                                                id="seaborne_patrol_activity_conduct_<?php echo $row->id  ?>"
                                                value="<?php echo $row->id  ?>">
                                            <label
                                                for="seaborne_patrol_activity_conduct_<?php echo $row->id  ?>"><?php echo $row->seaborne_patrol_activity_conduct ?></label>
                                        </div>
                                        <?php
														}
													?>
                            ...
                            <!-- <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" name="seaborne_patrol_number_conduncted"
                                            class="form-control">
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" name="seaborne_patrol_number_hour_conducted"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="date" name="shore_patrol_date" required class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group ">
                                            <span class="input-group-btn">
                                                <select name="shore_patrol_hour_started" class="form-control" required>
                                                    <option value=""> </option>
                                                    <?php 
																	foreach(range(intval('00:00:00'),intval('23:00:00')) as $time) {
																?>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-12">DTG</label>
                                    <div class="col-sm-12">
                                        <input type="date" name="sea_marshall_date" required class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group ">
                                            <span class="input-group-btn">
                                                <select name="sea_marshall_hour_started" class="form-control" required>
                                                    <option value=""> </option>
                                                    <?php 
																	foreach(range(intval('00:00:00'),intval('23:00:00')) as $time) {
																?>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-12">DTG</label>
                                    <div class="col-sm-12">
                                        <input type="date" name="panelling_conducted_date" required
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="panelling_conducted_facilities[]"
                                                id="panelling_conducted_facilities_<?php echo $row->id  ?>"
                                                value="<?php echo $row->id  ?>">
                                            <label
                                                for="panelling_conducted_facilities_<?php echo $row->id  ?>"><?php echo $row->panelling_conducted_facilities ?></label>
                                        </div>
                                        <?php
														}
													?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="k9_deployed_type[]"
                                                id="k9_deployed_type_<?php echo $row->id  ?>"
                                                value="<?php echo $row->id  ?>">
                                            <label
                                                for="k9_deployed_type_<?php echo $row->id  ?>"><?php echo $row->k9_deployed_type ?></label>
                                        </div>
                                        <?php
														}
													?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="eod_deployment[]"
                                                id="eod_deployment_<?php echo $row->id  ?>"
                                                value="<?php echo $row->id  ?>">
                                            <label
                                                for="eod_deployment_<?php echo $row->id  ?>"><?php echo $row->eod_deployment ?></label>
                                        </div>
                                        <?php
														}
													?>
