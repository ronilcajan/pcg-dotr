<div class="container-fluid">
    <div class="row">
        <div class="col-sm-6">
            <div class="white-box">
                <h3 class="box-title m-b-10">ENTER DATA FOR MARITIME SEARCH AND RESCUE REPORT</h3>
                ...
                <form method="POST" action="<?= site_url() ?>insert_marsar" role="form" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="station" name="station" class="form-control">
                                            ...
                                            ?>
                                            <option <?= $selected ?> value="<?= $row->station_id ?>">
                                                <?= $row->station ?> </option>
                                            <?php
                                                }
                                            ?>
                            ...
                            <div class="toggle-show" data-id="<?= $maritime_incident_type_id; ?>" style="display:none">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" class="step-2" name="incident_cause[]"
                                                    id="incident_cause_<?= $maritime_incident_type_id . "_" . $row->id  ?>"
                                                    value="<?= $row->id  ?>">
                                                <label
                                                    for="incident_cause_<?= $maritime_incident_type_id . "_" . $row->id  ?>"><?= $row->incident_cause ?></label>
                                            </div>
                                            <?php
                                                }
                                            ?>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            ?>
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" class="step-2" name="fire_cause[]"
                                                    id="fire_cause_<?= $maritime_incident_type_id . "_" . $row->id  ?>"
                                                    value="<?= $row->id  ?>">
                                                <label
                                                    for="fire_cause_<?= $maritime_incident_type_id . "_" . $row->id  ?>"><?= $row->fire_cause ?></label>
                                            </div>
                                            <?php
                                                }
                                            ?>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            ?>
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" class="step-2"
                                                    name="man_overboard_incident_cause[]"
                                                    id="man_overboard_incident_cause_<?= $maritime_incident_type_id . "_" . $row->id  ?>"
                                                    value="<?= $row->id  ?>">
                                                <label
                                                    for="man_overboard_incident_cause_<?= $maritime_incident_type_id . "_" . $row->id  ?>"><?= $row->man_overboard_incident_cause ?></label>
                                            </div>
                                            <?php
                                                }
                                            ?>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            ?>
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" class="step-2" name="vessel_type_involved[]"
                                                    id="vessel_type_involved_<?= $maritime_incident_type_id . "_" . $row->id  ?>"
                                                    value="<?= $row->id  ?>">
                                                <label
                                                    for="vessel_type_involved_<?= $maritime_incident_type_id . "_" . $row->id  ?>"><?= $row->vessel_type_involved ?></label>
                                            </div>
                                            <?php
                                                }
                                            ?>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <select name="vessel_age_1" class="form-control step-2">
                                                ...
                                                ?>
                                                <option value="<?= $row->id; ?>"><?= $row->vessel_age ?>
                                                </option>
                                                <?php
                                                    }
                                                ?>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <select name="vessel_size_1" class="form-control step-2">
                                                ...
                                                ?>
                                                <option value="<?= $row->id; ?>"><?= $row->vessel_size ?>
                                                </option>
                                                <?php
                                                    }
                                                ?>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="registry_port_1" class="form-control step-2">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="departure_port_1" class="form-control step-2">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="call_next_port_1" class="form-control step-2">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            ?>
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" class="step-2" name="vessel_size_2[]"
                                                    id="vessel_size_<?= $maritime_incident_type_id . "_" . $row->id  ?>"
                                                    value="<?= $row->id  ?>">
                                                <label
                                                    for="vessel_size_<?= $maritime_incident_type_id . "_" . $row->id  ?>"><?= $row->vessel_size ?></label>
                                            </div>
                                            <?php
                                                }
                                            ?>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="registry_port_2" class="form-control step-2">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="departure_port_2" class="form-control step-2">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="call_next_port_2" class="form-control step-2">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-12">Details on the location of incident. (latitude, longitude,
                                        ...
                                        reference)</label>
                                    <div class="col-sm-12">
                                        <input type="text" name="location_incident_location" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" name="survivor_number" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" name="casualty_number" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" name="missing_number" class="form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <?php 
                                            foreach($material_report as $row){
                                        ?>
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="material_report[]"
                                                id="material_report_<?= $row->id  ?>" value="<?= $row->id  ?>">
                                            <label
                                                for="material_report_<?= $row->id  ?>"><?= $row->material_report ?></label>
                                        </div>
                                        <?php
                                            }
                                        ?>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <?php  
                                            foreach($asset_deployment as $row){
                                        ?>
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="asset_deployment[]"
                                                id="asset_deployment_<?= $row->id  ?>" value="<?= $row->id  ?>">
                                            <label
                                                for="asset_deployment_<?= $row->id  ?>"><?= $row->asset_deployment ?></label>
                                        </div>
                                        <?php
                                            }
                                        ?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input type="checkbox" name="information_acquired_thru[]"
                                                id="information_acquired_thru_<?= $row->id  ?>"
                                                value="<?= $row->id  ?>">
                                            <label
                                                for="information_acquired_thru_<?= $row->id  ?>"><?= $row->information_acquired_thru ?></label>
                                        </div>
                                        <?php
                                            }
                                        ?>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="file" accept="application/msword, text/plain, application/pdf"
                                            name="radio_message_spot_report" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
