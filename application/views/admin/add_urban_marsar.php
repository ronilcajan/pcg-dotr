    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="white-box">
                ...
                <form method="POST" action="<?= site_url() ?>insert_urban_marsar" role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="radio-list">
                                        <?php 
														$arr = [ '3 DAYS', '4 DAYS', '5 DAYS', 'MORE THAN ONE WEEK', 'None',   ];
														foreach($arr  as $row){
													?>
                                        <div class="radio radio-info">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="radio-list">
                                        <?php 
														$arr = [ '12 HOURS', '24 HOURS', '36 HOURS', '72 HOURS', 'MORE THAN 72 HOURS', 'None'  ];
														foreach($arr  as $row){
													?>
                                        <div class="radio radio-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <?php 
													$arr = [ '0-1', '2-10', '11-20', '21-30', 'MORE THAN 30', 'None', ];
													foreach($arr  as $row){
												?>
                                    <div class="radio radio-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="">NUMBER OF CASUALTIES</label>
                                    <?php 
													$arr = [ '1-10', '10-20',  'MORE THAN 20', 'None', ];
													foreach($arr  as $row){
												?>
                                    <div class="radio radio-info">
